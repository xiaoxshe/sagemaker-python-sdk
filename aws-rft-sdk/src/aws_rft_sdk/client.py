...
class RolloutFeedbackClient:
    ...
    def __init__(self, metadata: dict):
        ...
        self._job_arn = self._metadata.get('job_arn') or self._metadata.get('jobId')
        self._trajectory_id = self._metadata.get('trajectory_id') or self._metadata.get('trajectoryId') or self._metadata.get('rolloutId')
        self._endpoint = (
            self._metadata.get('endpoint') or _DEFAULT_ENDPOINT
        )
